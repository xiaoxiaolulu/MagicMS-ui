<template>
    <div>
        ...
        <el-table
            ...
            <el-table-column prop="name" min-width="150" label="函数名称"></el-table-column>
            <el-table-column prop="function" min-width="150" label="编写函数"></el-table-column>
            <el-table-column prop="desc" min-width="150" label="函数描述"></el-table-column>
            ...
            <el-table-column label="操作" min-width="150">
                <template slot-scope="scope">
                    ...
                    <el-button @click="deleteFunctionData(scope.row)" type="text">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
...
<script>
    ...
    import {getFunctionList, deleteFunction} from "../../../api/api";
