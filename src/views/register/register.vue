    ...
    <div class="reset-container">
        <el-form autoComplete="on" :model="resetForm" :rules="resetRules" ref="resetForm" label-position="left"
            ...
            <el-form-item prop="code">
                <el-form-item prop="code">
                    <el-row :gutter="8">
                        <el-col :span="16"><el-input v-model="resetForm.code" placeholder="验证码"></el-input></el-col>
            ...
            <el-form-item style="width:100%;">
                <el-button type="primary" style="width:100%;" :loading="loading" @click="submitForm('resetForm')">
                    修改密码(注册)
                </el-button>
            </el-form-item>
        </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            obtainCode (formName) {
                ...
                if (!this.codeObtained && this.resetForm.email !== '') {
